"""
I really like pydantic. Let's make our events and aggregates pydantic-compatible
"""
...
from eventsourcing.domain import Aggregate as BaseAggregate, CanInitAggregate, CanMutateAggregate, CanSnapshotAggregate
